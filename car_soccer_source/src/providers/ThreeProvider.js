...
import { setVehicleSuspensionThreeContext } from '../entities/VehicleSuspensionSystem.js';
 ...
 * @param {object} [customContext] Optional custom Three.js context (defaults to standard npm three)
 * @returns {object} The resolved Three.js context object
 */
export function initializeSubsystemThreeContexts(customContext = THREE) {
  const T = customContext;
  applyThreeMonkeyPatches(T);
  ...
  setPostprocessingThreeContext({
    ...
    Object3D: T.Object3D,
    Material: T.Material,
    MeshLambertMaterial: T.MeshLambertMaterial || T.MeshBasicMaterial,
  ...
  setVehicleSuspensionThreeContext(T);
  ...
  setGameRuntimeThreeContext({
    ...
    MeshBasicMaterial: T.MeshBasicMaterial,
    Mesh: T.Mesh,
    PCFShadowMap: T.PCFShadowMap ?? T.PCFSoftShadowMap ?? 1,
    PCFSoftShadowMap: T.PCFShadowMap ?? T.PCFSoftShadowMap ?? 1,
    ACESFilmicToneMapping: T.ACESFilmicToneMapping,
    DoubleSide: T.DoubleSide,
    RoomEnvironment: RoomEnvironment
  });
