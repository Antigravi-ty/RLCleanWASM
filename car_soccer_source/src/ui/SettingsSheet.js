...
export class SettingsSheet {
              ...
              <section class="zone">
                ...
                <div class="zone__rows">
                  <div class="dim" data-dim-row="masterVolume">
                    <label class="dim__label" for="audio-master-volume">Master Volume (总音量)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                  ...
                  <div class="dim" data-dim-row="engineVolume">
                    <label class="dim__label" for="audio-engine-volume">Engine Volume (引擎声)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                  ...
                  <div class="dim" data-dim-row="boostVolume">
                    <label class="dim__label" for="audio-boost-volume">Boost & Match SFX (氮气与播报)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                  ...
                  <!-- Layer 1: Vehicle Self Audio -->
                  <div class="dim" data-dim-row="vehicleSelfVolume">
                    <label class="dim__label" for="audio-vehicle-self-volume">Layer 1: 车辆自身音效 (跳跃/翻滚/超音速)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                      <input id="audio-vehicle-self-volume" class="dim__line" type="range"
                             min="0" max="500" step="5" data-audio-setting="vehicleSelfVolume" />
                    </span>
                    <output class="figure" data-audio-value-for="vehicleSelfVolume"
                            for="audio-vehicle-self-volume"></output>
                  </div>

                  <!-- Layer 2: Car-Car Collision -->
                  <div class="dim" data-dim-row="carCarCollisionVolume">
                    <label class="dim__label" for="audio-car-car-volume">Layer 2: 车车碰撞音效 (撞车/爆破)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                      <input id="audio-car-car-volume" class="dim__line" type="range"
                             min="0" max="500" step="5" data-audio-setting="carCarCollisionVolume" />
                    </span>
                    <output class="figure" data-audio-value-for="carCarCollisionVolume"
                            for="audio-car-car-volume"></output>
                  </div>
                  <div class="dim" data-dim-row="carCarSoundMode">
                    <label class="dim__label" for="audio-car-car-sound-mode">车车碰撞音色选择</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                      <select id="audio-car-car-sound-mode" class="pick" data-audio-setting="carCarSoundMode">
                        <option value="sfx_collision">SFX Car Collision (经典)</option>
                        <option value="vehicle_detail">Vehicle Detail (6种真实细节随机)</option>
                      </select>
                    </span>
                  </div>

                  <!-- Layer 3: Ball Collisions -->
                  <div class="dim" data-dim-row="ballCollisionVolume">
                    <label class="dim__label" for="audio-ball-collision-volume">Layer 3: 球体碰撞音效 (击球/场地/门柱)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                    ...
                    <output class="figure" data-audio-value-for="ballCollisionVolume"
                            for="audio-ball-collision-volume"></output>
                  </div>
                  <div class="dim" data-dim-row="carBallHitCooldownMs">
                    <label class="dim__label" for="audio-carball-cooldown">击球音频防抖区间 (0-100ms)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                      <input id="audio-carball-cooldown" class="dim__line" type="range"
                             min="0" max="100" step="1" data-audio-setting="carBallHitCooldownMs" />
                    </span>
                    <output class="figure" data-audio-value-for="carBallHitCooldownMs"
                            for="audio-carball-cooldown"></output>
                  </div>
                  <div class="dim" data-dim-row="carBallHitImpulseThreshold">
                    <label class="dim__label" for="audio-carball-hit-impulse-threshold">击球冲量触发阈值</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control">
                      <input id="audio-carball-hit-impulse-threshold" class="dim__line" type="range"
                             min="0" max="500" step="5" data-audio-setting="carBallHitImpulseThreshold" />
                    </span>
                    <output class="figure" data-audio-value-for="carBallHitImpulseThreshold"
                            for="audio-carball-hit-impulse-threshold"></output>
                  </div>
                  <div class="dim dim--flag" data-dim-row="logCarBallHitEvents">
                    <label class="dim__label" for="audio-log-carball-hit-events">打印击球物理事件</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control dim__control--flag">
                      <input id="audio-log-carball-hit-events" class="tick" type="checkbox" data-audio-setting="logCarBallHitEvents" />
                      <span class="tick__mark" aria-hidden="true"></span>
                      <span class="dim__note">在浏览器控制台打印事件结构体</span>
                    </span>
                  </div>

                  <!-- Audio Preset JSON Management -->
                  <div class="dim dim--flag" style="margin-top: 10px;">
                    <label class="dim__label">配置文件管理 (audioConfig.json)</label>
                    <span class="dim__leader" aria-hidden="true"></span>
                    <span class="dim__control" style="display: flex; gap: 8px;">
                      <button id="btn-audio-export-json" type="button" class="field-btn" style="padding: 4px 10px; font-size: 11px;">导出 JSON</button>
                      <button id="btn-audio-import-json" type="button" class="field-btn" style="padding: 4px 10px; font-size: 11px;">导入 JSON</button>
  ...
  updateAudioRangePresentation(input) {
    ...
    if (key === 'carBallHitImpulseThreshold') {
      input.setAttribute('aria-valuetext', `${val}`);
      if (output) output.value = `${val}`;
    } else if (key === 'carBallHitCooldownMs') {
