...
export function resolvePostprocessingContext() {
  const threeContext = postprocessingThreeContext;
  return {
    ...THREE,
    ...threeContext
  };
...
export function createRoomEnvironmentMaterial(emissiveIntensity) {
  const { MeshLambertMaterial, MeshBasicMaterial } = resolvePostprocessingContext();
 ...
 */
export class FullScreenGeometry extends THREE.BufferGeometry {
  constructor() {
    super();
