...
export function resolveGeometryContext() {
  const threeContext = geometryThreeContext;
  return {
    ...THREE,
    ...threeContext,
    TrianglesDrawMode: threeContext.TrianglesDrawMode ?? TrianglesDrawMode,
    TriangleStripDrawMode: threeContext.TriangleStripDrawMode ?? TriangleStripDrawMode,
    TriangleFanDrawMode: threeContext.TriangleFanDrawMode ?? TriangleFanDrawMode
  };
}
